...
class Mysqldump
{
    ...
    protected $dumpSettingsDefault = array(
        ...
        'events' => false,
        'hex-blob' => true,
        'normalize-identifier-quotes' => false, /* faster than escaped content */
        'insert-ignore' => false,
...
if ("mysql" === $this->dbType) {
    ...
    if (defined('Pdo\\Mysql::ATTR_USE_BUFFERED_QUERY')) {
        $this->pdoSettingsDefault[Pdo\Mysql::ATTR_USE_BUFFERED_QUERY] = false;
...
abstract class TypeAdapterFactory
{
     ...
     */
    /**
     * Normalize ANSI quoted identifiers to MySQL backticks.
     */
    private function normalizeIdentifierQuotes($sql)
    {
        if (empty($this->dumpSettings['normalize-identifier-quotes'])) {
            return $sql;
        }
...
class TypeAdapterMysql extends TypeAdapterFactory
{
    ...
    public function create_table($row)
    {
        ...
        $createTable = $this->normalizeIdentifierQuotes($row['Create Table']);
    ...
    public function create_view($row)
    {
        ...
        $viewStmt = $this->normalizeIdentifierQuotes($row['Create View']);
    ...
    public function create_trigger($row)
    {
        ...
        $triggerStmt = $this->normalizeIdentifierQuotes($row['SQL Original Statement']);
    ...
    public function create_procedure($row)
    {
        ...
        $procedureStmt = $this->normalizeIdentifierQuotes($row['Create Procedure']);
    ...
    public function create_function($row)
    {
        ...
        $functionStmt = $this->normalizeIdentifierQuotes($row['Create Function']);
    ...
    public function create_event($row)
    {
        ...
        $eventName = $row['Event'];
        $eventStmt = $this->normalizeIdentifierQuotes($row['Create Event']);
        $sqlMode = $row['sql_mode'];
